...
router.get('/thankyou', function (req, res, next) {
	 return res.render("seniors.ejs");
});


router.post('/thankyou', function (req, res, next) {
	return res.redirect("seniors.ejs");
});
...
router.post('/feedback', function (req, res, next) {
   return res.redirect("feedback.ejs");
});
...
router.post('/aboutus', function (req, res, next) {
   return res.redirect("aboutus.ejs");
});


router.get('/python', function (req, res, next) {
	return res.render("python.ejs");
});


router.post('/python', function (req, res, next) {
   return res.redirect("python.ejs");
});
